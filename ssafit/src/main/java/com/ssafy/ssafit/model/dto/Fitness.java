...
public enum Fitness {
 ...
 Dumbbell_Press(37, "덤벨 프레스", Muscle.Pectoralis_Major ,
                Arrays.asList(Muscle.Deltoids_Front, Muscle.Triceps_Brachii),
                 Arrays.asList()),
 Machine_Press(38, "머신 프레스", Muscle.Pectoralis_Major ,
         Arrays.asList(Muscle.Deltoids_Front),
         Arrays.asList()),
 Dumbbell_Fly(39, "덤벨 플라이", Muscle.Pectoralis_Major ,
         Arrays.asList(Muscle.Deltoids_Front),
         Arrays.asList()),
 Cable_Fly(40, "케이블 플라이", Muscle.Pectoralis_Major ,
         Arrays.asList(Muscle.Deltoids_Front),
         Arrays.asList()),
 Machine_Fly(41, "머신 플라이", Muscle.Pectoralis_Major ,
         Arrays.asList(Muscle.Deltoids_Front),
         Arrays.asList()),
 Dumbbell_Pull_Over(42, "덤벨 풀오버", Muscle.Pectoralis_Major ,
         Arrays.asList(Muscle.Latissimus_Dorsi),
         Arrays.asList(Muscle.Abdominal_Muscles)),
 Barbell_Pull_Over(43, "바벨 풀오버", Muscle.Pectoralis_Major ,
         Arrays.asList(Muscle.Latissimus_Dorsi),
         Arrays.asList()),

 // 등 운동
 UnderGrip_Lat_Pull_Down(44, "언더 그립 렛풀다운", Muscle.Latissimus_Dorsi ,
         Arrays.asList(Muscle.Biceps_Brachii),
         Arrays.asList(Muscle.Forearm, Muscle.Trapezius)),
 OverGrip_Lat_Pull_Down(45, "오버 그립 렛풀다운", Muscle.Latissimus_Dorsi ,
         Arrays.asList(Muscle.Trapezius, Muscle.Deltoids_Posterior),
         Arrays.asList(Muscle.Forearm)),
 Overhead_Lat_Pull_Down(46, "오버 헤드 렛풀다운", Muscle.Latissimus_Dorsi ,
         Arrays.asList(Muscle.Trapezius),
         Arrays.asList(Muscle.Forearm)),
 Pull_Up(47, "풀업", Muscle.Latissimus_Dorsi ,
         Arrays.asList(Muscle.Trapezius),
         Arrays.asList(Muscle.Forearm, Muscle.Deltoids_Posterior, Muscle.Biceps_Brachii)),
 Arm_Pull_Down(48, "암풀다운", Muscle.Latissimus_Dorsi ,
         Arrays.asList(Muscle.Trapezius),
         Arrays.asList()),
 Cable_Seated_Row(49, "케이블 시티드 로우", Muscle.Latissimus_Dorsi ,
         Arrays.asList(Muscle.Trapezius, Muscle.Deltoids_Posterior),
         Arrays.asList(Muscle.Forearm)),
 One_Arm_Row(50, "원암로우", Muscle.Latissimus_Dorsi ,
         Arrays.asList(Muscle.Trapezius),
         Arrays.asList(Muscle.Deltoids_Posterior)),
 Dumbbell_Row(51, "덤벨 로우", Muscle.Latissimus_Dorsi ,
         Arrays.asList(Muscle.Trapezius, Muscle.Deltoids_Posterior),
         Arrays.asList()),
 T_Bar_Row(52, "티바 로우", Muscle.Latissimus_Dorsi ,
         Arrays.asList(Muscle.Trapezius, Muscle.Deltoids_Posterior),
         Arrays.asList()),
 Barbell_Row(53, "바벨 로우", Muscle.Latissimus_Dorsi ,
         Arrays.asList(Muscle.Trapezius, Muscle.Gluteus),
         Arrays.asList(Muscle.Forearm, Muscle.Quadriceps_Femoris)),
 Bent_Over_Barbell_Row(54, "벤트 오버 바벨 로우", Muscle.Latissimus_Dorsi ,
         Arrays.asList(Muscle.Trapezius, Muscle.Deltoids_Posterior),
         Arrays.asList(Muscle.Forearm));
